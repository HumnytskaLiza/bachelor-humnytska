...
Employee Onboarding Platform - це прототип веб-система для проведення онбордингу нових працівників у малих компаніях. Система підтримує створення персоналіхованих шляхів онбордингу із завданнями, відстежує інформацію про нових співробітників та містить базу корпоративних докуміентів та тренінгових матеріалів. Однією з її особливостей є присутність інтелектуального помічника на базі штучного інтелекту, який надає контекстну підтримку адаптації та відповідає на запитання, пов’язані з компанією та внутрішніми процесами. Система побудована за допомогою Next.js, Tailwind CSS, Supabase та OpenAI (Vercel AI SDK) і розгорнута на Vercel.
